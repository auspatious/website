...
<footer class="mx-auto flex max-w-5xl flex-col-reverse items-center justify-between gap-6 p-6 pt-12 text-white md:flex-row md:items-end md:p-10 md:pt-26">
